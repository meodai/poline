"use strict";var polinePicker=(()=>{var y=Object.defineProperty;var H=Object.getOwnPropertyDescriptor;var N=Object.getOwnPropertyNames;var q=Object.prototype.hasOwnProperty;var b=Math.pow;var O=(r,t)=>{for(var n in t)y(r,n,{get:t[n],enumerable:!0})},Z=(r,t,n,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let o of N(t))!q.call(r,o)&&o!==n&&y(r,o,{get:()=>t[o],enumerable:!(i=H(t,o))||i.enumerable});return r};var U=r=>Z(y({},"__esModule",{value:!0}),r);var rt={};O(rt,{Poline:()=>L,PolinePicker:()=>x,positionFunctions:()=>Y});var F=(r,t)=>{let[n,i,o]=r,e=.5,a=.5,c=Math.atan2(i-a,n-e)*(180/Math.PI);c=(360+c)%360;let h=o,p=Math.sqrt(Math.pow(i-a,2)+Math.pow(n-e,2))/e;return[c,h,t?1-p:p]},k=(r,t)=>{let[n,i,o]=r,e=.5,a=.5,s=n/(180/Math.PI),c=(t?1-o:o)*e,h=e+c*Math.cos(s),u=a+c*Math.sin(s);return[h,u,i]},D=(r=Math.random()*360,t=[Math.random(),Math.random()],n=[.75+Math.random()*.2,.3+Math.random()*.2])=>[[r,t[0],n[0]],[(r+60+Math.random()*180)%360,t[1],n[1]]],R=(r,t)=>{let o=r-.5,e=t-.5,a=Math.hypot(o,e);return a<=.5?[r,t]:[.5+o/a*.5,.5+e/a*.5]};var X=(r,t,n,i=!1,o=(s,c)=>c?1-s:s,e=(s,c)=>c?1-s:s,a=(s,c)=>c?1-s:s)=>{let s=o(r,i),c=e(r,i),h=a(r,i),u=(1-s)*t[0]+s*n[0],p=(1-c)*t[1]+c*n[1],l=(1-h)*t[2]+h*n[2];return[u,p,l]},B=(r,t,n=4,i=!1,o=(s,c)=>c?1-s:s,e=(s,c)=>c?1-s:s,a=(s,c)=>c?1-s:s)=>{let s=[];for(let c=0;c<n;c++){let[h,u,p]=X(c/(n-1),r,t,i,o,e,a);s.push([h,u,p])}return s},W=r=>r,K=(r,t=!1)=>t?1-b(1-r,2):b(r,2),J=(r,t=!1)=>t?1-b(1-r,3):b(r,3),Q=(r,t=!1)=>t?1-b(1-r,4):b(r,4),tt=(r,t=!1)=>t?1-b(1-r,5):b(r,5),_=(r,t=!1)=>t?1-Math.sin((1-r)*Math.PI/2):Math.sin(r*Math.PI/2),nt=(r,t=!1)=>t?1-Math.asin(1-r)/(Math.PI/2):Math.asin(r)/(Math.PI/2),it=(r,t=!1)=>t?1-Math.sqrt(1-b(r,2)):1-Math.sqrt(1-r),ot=r=>b(r,2)*(3-2*r),Y={linearPosition:W,exponentialPosition:K,quadraticPosition:J,cubicPosition:Q,quarticPosition:tt,sinusoidalPosition:_,asinusoidalPosition:nt,arcPosition:it,smoothStepPosition:ot},z=(r,t,n=!1)=>{let i=r[0],o=t[0],e=0;n&&i!==null&&o!==null?(e=Math.min(Math.abs(i-o),360-Math.abs(i-o)),e=e/360):e=i===null||o===null?0:i-o;let a=e,s=r[1]===null||t[1]===null?0:t[1]-r[1],c=r[2]===null||t[2]===null?0:t[2]-r[2];return Math.sqrt(a*a+s*s+c*c)},S=class{constructor({xyz:t,color:n,invertedLightness:i=!1}={}){this.x=0;this.y=0;this.z=0;this.color=[0,0,0];this._invertedLightness=!1;this._invertedLightness=i,this.positionOrColor({xyz:t,color:n,invertedLightness:i})}positionOrColor({xyz:t,color:n,invertedLightness:i=!1}){if(this._invertedLightness=i,t&&n||!t&&!n)throw new Error("Point must be initialized with either x,y,z or hsl");t?(this.x=t[0],this.y=t[1],this.z=t[2],this.color=F([this.x,this.y,this.z],i)):n&&(this.color=n,[this.x,this.y,this.z]=k(n,i))}set position([t,n,i]){this.x=t,this.y=n,this.z=i,this.color=F([this.x,this.y,this.z],this._invertedLightness)}get position(){return[this.x,this.y,this.z]}set hsl([t,n,i]){this.color=[t,n,i],[this.x,this.y,this.z]=k(this.color,this._invertedLightness)}get hsl(){return this.color}get hslCSS(){let[t,n,i]=this.color;return`hsl(${t.toFixed(2)}, ${(n*100).toFixed(2)}%, ${(i*100).toFixed(2)}%)`}get oklchCSS(){let[t,n,i]=this.color;return`oklch(${(i*100).toFixed(2)}% ${(n*.4).toFixed(3)} ${t.toFixed(2)})`}get lchCSS(){let[t,n,i]=this.color;return`lch(${(i*100).toFixed(2)}% ${(n*150).toFixed(2)} ${t.toFixed(2)})`}set invertedLightness(t){this._invertedLightness=t,this.color=F([this.x,this.y,this.z],this._invertedLightness)}get invertedLightness(){return this._invertedLightness}shiftHue(t){this.color[0]=(360+(this.color[0]+t))%360,[this.x,this.y,this.z]=k(this.color,this._invertedLightness)}},L=class{constructor({anchorColors:t=D(),numPoints:n=4,positionFunction:i=_,positionFunctionX:o,positionFunctionY:e,positionFunctionZ:a,closedLoop:s,invertedLightness:c,clampToCircle:h}={}){this._positionFunctionX=_;this._positionFunctionY=_;this._positionFunctionZ=_;this.connectLastAndFirstAnchor=!1;this._invertedLightness=!1;this._clampToCircle=!1;if(!t||t.length<2)throw new Error("Must have at least two anchor colors");this._anchorPoints=t.map(u=>new S({color:u,invertedLightness:c})),this._numPoints=n+2,this._positionFunctionX=o||i||_,this._positionFunctionY=e||i||_,this._positionFunctionZ=a||i||_,this.connectLastAndFirstAnchor=s||!1,this._invertedLightness=c||!1,this._clampToCircle=h||!1,this.updateAnchorPairs()}get numPoints(){return this._numPoints-2}set numPoints(t){if(t<1)throw new Error("Must have at least one point");this._numPoints=t+2,this.updateAnchorPairs()}set positionFunction(t){if(Array.isArray(t)){if(t.length!==3)throw new Error("Position function array must have 3 elements");if(typeof t[0]!="function"||typeof t[1]!="function"||typeof t[2]!="function")throw new Error("Position function array must have 3 functions");this._positionFunctionX=t[0],this._positionFunctionY=t[1],this._positionFunctionZ=t[2]}else this._positionFunctionX=t,this._positionFunctionY=t,this._positionFunctionZ=t;this.updateAnchorPairs()}get positionFunction(){return this._positionFunctionX===this._positionFunctionY&&this._positionFunctionX===this._positionFunctionZ?this._positionFunctionX:[this._positionFunctionX,this._positionFunctionY,this._positionFunctionZ]}set positionFunctionX(t){this._positionFunctionX=t,this.updateAnchorPairs()}get positionFunctionX(){return this._positionFunctionX}set positionFunctionY(t){this._positionFunctionY=t,this.updateAnchorPairs()}get positionFunctionY(){return this._positionFunctionY}set positionFunctionZ(t){this._positionFunctionZ=t,this.updateAnchorPairs()}get positionFunctionZ(){return this._positionFunctionZ}get clampToCircle(){return this._clampToCircle}set clampToCircle(t){this._clampToCircle=t}get anchorPoints(){return this._anchorPoints}set anchorPoints(t){this._anchorPoints=t,this.updateAnchorPairs()}updateAnchorPairs(){this._anchorPairs=[];let t=this.connectLastAndFirstAnchor?this.anchorPoints.length:this.anchorPoints.length-1;for(let n=0;n<t;n++){let i=[this.anchorPoints[n],this.anchorPoints[(n+1)%this.anchorPoints.length]];this._anchorPairs.push(i)}this.points=this._anchorPairs.map((n,i)=>{let o=n[0]?n[0].position:[0,0,0],e=n[1]?n[1].position:[0,0,0],a=this.shouldInvertEaseForSegment(i);return B(o,e,this._numPoints,a,this.positionFunctionX,this.positionFunctionY,this.positionFunctionZ).map(s=>new S({xyz:s,invertedLightness:this._invertedLightness}))})}addAnchorPoint({xyz:t,color:n,insertAtIndex:i,clamp:o}){let e=t;if((o!=null?o:this._clampToCircle)&&t){let[c,h,u]=t,[p,l]=R(c,h);e=[p,l,u]}let s=new S({xyz:e,color:n,invertedLightness:this._invertedLightness});return i!==void 0?this.anchorPoints.splice(i,0,s):this.anchorPoints.push(s),this.updateAnchorPairs(),s}removeAnchorPoint({point:t,index:n}){if(!t&&n===void 0)throw new Error("Must provide a point or index");if(this.anchorPoints.length<3)throw new Error("Must have at least two anchor points");let i=n!==void 0?n:this.anchorPoints.indexOf(t);if(i>=0&&i<this.anchorPoints.length)this.anchorPoints.splice(i,1),this.updateAnchorPairs();else throw new Error("Point not found")}updateAnchorPoint({point:t,pointIndex:n,xyz:i,color:o,clamp:e}){if(n!==void 0&&(t=this.anchorPoints[n]),!t)throw new Error("Must provide a point or pointIndex");if(!i&&!o)throw new Error("Must provide a new xyz position or color");if(i)if(e!=null?e:this._clampToCircle){let[s,c,h]=i,[u,p]=R(s,c);t.position=[u,p,h]}else t.position=i;return o&&(t.hsl=o),this.updateAnchorPairs(),t}getClosestAnchorPoint({xyz:t,hsl:n,maxDistance:i=1}){if(!t&&!n)throw new Error("Must provide a xyz or hsl");let o;t?o=this.anchorPoints.map(s=>z(s.position,t)):n&&(o=this.anchorPoints.map(s=>z(s.hsl,n,!0)));let e=Math.min(...o);if(e>i)return null;let a=o.indexOf(e);return this.anchorPoints[a]||null}set closedLoop(t){this.connectLastAndFirstAnchor=t,this.updateAnchorPairs()}get closedLoop(){return this.connectLastAndFirstAnchor}set invertedLightness(t){this._invertedLightness=t,this.anchorPoints.forEach(n=>n.invertedLightness=t),this.updateAnchorPairs()}get invertedLightness(){return this._invertedLightness}get flattenedPoints(){return this.points.flat().filter((t,n)=>n!=0?n%this._numPoints:!0)}get colors(){let t=this.flattenedPoints.map(n=>n.color);return this.connectLastAndFirstAnchor&&this._anchorPoints.length!==2&&t.pop(),t}cssColors(t="hsl"){let n={hsl:o=>o.hslCSS,oklch:o=>o.oklchCSS,lch:o=>o.lchCSS},i=this.flattenedPoints.map(n[t]);return this.connectLastAndFirstAnchor&&i.pop(),i}get colorsCSS(){return this.cssColors("hsl")}get colorsCSSlch(){return this.cssColors("lch")}get colorsCSSoklch(){return this.cssColors("oklch")}shiftHue(t=20){this.anchorPoints.forEach(n=>n.shiftHue(t)),this.updateAnchorPairs()}getColorAt(t){var v;if(t<0||t>1)throw new Error("Position must be between 0 and 1");if(this.anchorPoints.length===0)throw new Error("No anchor points available");let n=this.connectLastAndFirstAnchor?this.anchorPoints.length:this.anchorPoints.length-1,i=this.connectLastAndFirstAnchor&&this.anchorPoints.length===2?2:n,o=t*i,e=Math.floor(o),a=o-e,s=e>=i?i-1:e,c=e>=i?1:a,h=this._anchorPairs[s];if(!h||h.length<2||!h[0]||!h[1])return new S({color:((v=this.anchorPoints[0])==null?void 0:v.color)||[0,0,0],invertedLightness:this._invertedLightness});let u=h[0].position,p=h[1].position,l=this.shouldInvertEaseForSegment(s),m=X(c,u,p,l,this._positionFunctionX,this._positionFunctionY,this._positionFunctionZ);return new S({xyz:m,invertedLightness:this._invertedLightness})}shouldInvertEaseForSegment(t){return!!(t%2||this.connectLastAndFirstAnchor&&this.anchorPoints.length===2&&t===0)}},{p5:M}=globalThis;if(M&&M.VERSION&&M.VERSION.startsWith("1.")){console.info("p5 < 1.x detected, adding poline to p5 prototype");let r=new L;M.prototype.poline=r;let t=()=>r.colors.map(n=>`hsl(${Math.round(n[0])},${n[1]*100}%,${n[2]*100}%)`);M.prototype.registerMethod("polineColors",t),globalThis.poline=r,globalThis.polineColors=t}var C="http://www.w3.org/2000/svg",g=100,f={anchorRadius:2,ringOuterRadius:5,ringThickness:1,ringThicknessHover:2,ringGap:.5,tickLength:1.5,tickGap:.5},et=1,st=2.5,x=class extends HTMLElement{constructor(){super();this.currentPoint=null;this.allowAddPoints=!1;this.ringAdjust=null;this.ringHoverIndex=null;this.boundPointerDown=this.handlePointerDown.bind(this);this.boundPointerMove=this.handlePointerMove.bind(this);this.boundPointerUp=this.handlePointerUp.bind(this);this.attachShadow({mode:"open"}),this.interactive=this.hasAttribute("interactive"),this.allowAddPoints=this.hasAttribute("allow-add-points")}connectedCallback(){this.interactive=this.hasAttribute("interactive"),this.allowAddPoints=this.hasAttribute("allow-add-points"),this.render(),this.interactive&&this.addEventListeners()}disconnectedCallback(){this.removeEventListeners()}setPoline(n){this.poline=n,this.updateSVG(),this.updateLightnessBackground()}setAllowAddPoints(n){this.allowAddPoints=n}addPointAtPosition(n,i){if(!this.poline)return null;let o=n/this.svg.clientWidth,e=i/this.svg.clientHeight,a=this.poline.addAnchorPoint({xyz:[o,e,e]});return this.updateSVG(),this.dispatchPolineChange(),a}updateLightnessBackground(){var i;let n=(i=this.shadowRoot)==null?void 0:i.querySelector(".picker");n&&this.poline&&(this.poline.invertedLightness?(n.style.setProperty("--maxL","#000"),n.style.setProperty("--minL","#fff")):(n.style.setProperty("--maxL","#fff"),n.style.setProperty("--minL","#000")))}render(){if(!this.shadowRoot)return;this.shadowRoot.innerHTML=`
    ...
    `,n}updateSVG(){if(!this.poline||!this.svg)return;let n=this.poline.flattenedPoints,i=n.map(e=>{let a=this.pointToCartesian(e);if(!a)return"";let[s,c]=a;return`${s},${c}`}).filter(e=>e!=="").join(" ");this.line.setAttribute("points",i);let o=(e,a,s,c)=>{let h=e.children;for(;h.length>a.length;){let u=h[h.length-1];u&&e.removeChild(u)}a.forEach((u,p)=>{let l=h[p],m=this.pointToCartesian(u);if(!m)return;let[v=0,P=0]=m,d=c(u),A=u.hslCSS;l||(l=document.createElementNS(C,"circle"),l.setAttribute("class",s),e.appendChild(l)),l.setAttribute("cx",v.toString()),l.setAttribute("cy",P.toString()),l.setAttribute("r",d.toString()),l.setAttribute("fill",A)})};this.updateSaturationRings(),o(this.anchors,this.poline.anchorPoints,"wheel__anchor",()=>f.anchorRadius),o(this.points,n,"wheel__point",e=>.5+e.color[1])}updateSaturationRings(){if(!this.poline||!this.saturationRings)return;let n=this.poline.anchorPoints,i=Array.from(this.saturationRings.querySelectorAll(".wheel__ring-group"));for(;i.length>n.length;){let o=i.pop();o&&o.remove()}n.forEach((o,e)=>{let a=this.pointToCartesian(o);if(!a)return;let[s,c]=a,h=o.z,u=f.anchorRadius+f.ringGap+1,p=this.ringHoverIndex===e||this.ringAdjust&&this.ringAdjust.anchorIndex===e,l=i[e];if(!l){l=document.createElementNS(C,"g"),l.setAttribute("class","wheel__ring-group");let T=document.createElementNS(C,"circle");T.setAttribute("class","wheel__ring-bg"),l.appendChild(T);let I=document.createElementNS(C,"path");I.setAttribute("class","wheel__saturation-ring"),l.appendChild(I);let G=document.createElementNS(C,"line");G.setAttribute("class","wheel__ring-tick"),l.appendChild(G),this.saturationRings.appendChild(l),i.push(l)}l.classList.toggle("wheel__ring-group--hover",!!p);let m=l.querySelector(".wheel__ring-bg");m.setAttribute("cx",s.toString()),m.setAttribute("cy",c.toString()),m.setAttribute("r",u.toString());let v=l.querySelector(".wheel__saturation-ring"),P=-Math.PI/2,d=P+h*Math.PI*2,A=this.describeArc(s,c,u,P,d);v.setAttribute("d",A);let w=l.querySelector(".wheel__ring-tick"),V=s+(u+f.tickGap)*Math.cos(d),E=c+(u+f.tickGap)*Math.sin(d),$=V+Math.cos(d)*f.tickLength,j=E+Math.sin(d)*f.tickLength;w.setAttribute("x1",V.toString()),w.setAttribute("y1",E.toString()),w.setAttribute("x2",$.toString()),w.setAttribute("y2",j.toString())})}describeArc(n,i,o,e,a){let s=a-e;if(Math.abs(s)<.001)return"";if(Math.abs(s)>Math.PI*2-.01){let v=e+Math.PI,P=n+o*Math.cos(e),d=i+o*Math.sin(e),A=n+o*Math.cos(v),w=i+o*Math.sin(v);return`M ${P} ${d} A ${o} ${o} 0 1 1 ${A} ${w} A ${o} ${o} 0 1 1 ${P} ${d}`}let c=n+o*Math.cos(e),h=i+o*Math.sin(e),u=n+o*Math.cos(a),p=i+o*Math.sin(a),l=s>Math.PI?1:0;return`M ${c} ${h} A ${o} ${o} 0 ${l} ${1} ${u} ${p}`}pointToCartesian(n){let i=g/2,o=i+(n.x-.5)*g,e=i+(n.y-.5)*g;return[o,e]}addEventListeners(){this.svg&&(this.svg.addEventListener("pointerdown",this.boundPointerDown),this.svg.addEventListener("pointermove",this.boundPointerMove),this.svg.addEventListener("pointerup",this.boundPointerUp))}removeEventListeners(){this.svg&&(this.svg.removeEventListener("pointerdown",this.boundPointerDown),this.svg.removeEventListener("pointermove",this.boundPointerMove),this.svg.removeEventListener("pointerup",this.boundPointerUp))}handlePointerDown(n){n.stopPropagation();let{normalizedX:i,normalizedY:o}=this.pointerToNormalizedCoordinates(n),a=window.matchMedia("(pointer: coarse)").matches?null:this.pickRing(i,o);if(a!==null){let c=this.poline.anchorPoints[a];if(!c)return;let h=this.pointToCartesian(c);if(!h)return;let[u,p]=h,l=i*g,m=o*g,v=Math.atan2(m-p,l-u);this.ringAdjust={anchorIndex:a,startSaturation:c.color[1],startAngle:v,prevAngle:v,accumulatedAngle:0},this.ringHoverIndex=a,this.classList.add("ring-adjusting"),this.updateSaturationRings();try{this.svg.setPointerCapture(n.pointerId)}catch(P){}return}let s=this.poline.getClosestAnchorPoint({xyz:[i,o,null],maxDistance:.05});s?this.currentPoint=s:this.allowAddPoints&&(this.currentPoint=this.poline.addAnchorPoint({xyz:[i,o,o]}),this.updateSVG(),this.dispatchPolineChange())}handlePointerMove(n){let{normalizedX:i,normalizedY:o}=this.pointerToNormalizedCoordinates(n);if(this.ringAdjust){let e=this.poline.anchorPoints[this.ringAdjust.anchorIndex];if(!e)return;let a=this.pointToCartesian(e);if(!a)return;let[s,c]=a,h=i*g,u=o*g,p=Math.atan2(u-c,h-s),l=p-this.ringAdjust.prevAngle;l>Math.PI?l-=Math.PI*2:l<-Math.PI&&(l+=Math.PI*2),this.ringAdjust.accumulatedAngle+=l,this.ringAdjust.prevAngle=p;let m=this.ringAdjust.accumulatedAngle/(Math.PI*2),v=n.shiftKey?st:et,P=m/v,d=this.clamp01(this.ringAdjust.startSaturation+P);d>.99&&(d=1),d<.01&&(d=0);let A=d===0||d===1,w=d===1&&P>0||d===0&&P<0;A&&w&&(this.ringAdjust.startSaturation=d,this.ringAdjust.accumulatedAngle=0,this.ringAdjust.prevAngle=p),this.poline.updateAnchorPoint({point:e,color:[e.color[0],d,e.color[2]]}),this.updateSVG(),this.dispatchPolineChange();return}if(this.currentPoint){this.poline.updateAnchorPoint({point:this.currentPoint,xyz:[i,o,this.currentPoint.z]}),this.updateSVG(),this.dispatchPolineChange();return}if(!window.matchMedia("(pointer: coarse)").matches){let e=this.pickRing(i,o);e!==this.ringHoverIndex&&(this.ringHoverIndex=e,this.classList.toggle("ring-hover",e!==null),this.updateSaturationRings())}}handlePointerUp(n){if(this.ringAdjust){try{this.svg.releasePointerCapture(n.pointerId)}catch(a){}this.classList.remove("ring-adjusting")}this.ringAdjust=null,this.currentPoint=null;let{normalizedX:i,normalizedY:o}=this.pointerToNormalizedCoordinates(n),e=this.pickRing(i,o);e!==this.ringHoverIndex&&(this.ringHoverIndex=e,this.classList.toggle("ring-hover",e!==null),this.updateSaturationRings())}pickRing(n,i){if(!this.poline)return null;let o=n*g,e=i*g;for(let a=0;a<this.poline.anchorPoints.length;a++){let s=this.poline.anchorPoints[a];if(!s)continue;let c=this.pointToCartesian(s);if(!c)continue;let[h,u]=c,p=Math.hypot(o-h,e-u);if(p>f.anchorRadius&&p<=f.ringOuterRadius)return a}return null}clamp01(n){return Math.max(0,Math.min(1,n))}pointerToNormalizedCoordinates(n){let i=this.svg.getBoundingClientRect(),o=(n.clientX-i.left)/i.width*g,e=(n.clientY-i.top)/i.height*g;return{normalizedX:o/g,normalizedY:e/g}}dispatchPolineChange(){this.dispatchEvent(new CustomEvent("poline-change",{detail:{poline:this.poline}}))}};customElements.define("poline-picker",x);return U(rt);})();
